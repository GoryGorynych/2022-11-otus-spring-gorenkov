...
import ru.otus.gorenkov.service.BookProcessor;
...
public class ApplicationComands {
    ...
    public String showBookById(@ShellOption(defaultValue = "0") String id) {
    ...
    public String editBook(@ShellOption(defaultValue = "0") String id,
    ...
    public String deleteBook(@ShellOption(defaultValue = "0") String id) {
        return bookProcessor.delete(id);
    }

    @ShellMethod(value = "Add comment to book", key = {"comment", "com"})
    public String addComment(@ShellOption(defaultValue = "0") String bookId,
    ...
    public String editComment(@ShellOption (defaultValue = "0") String id, @ShellOption String text) {
        return bookProcessor.editComment(id, text);
    }

    @ShellMethod(value = "Delete all comments by book", key = {"delcom", "dcom"})
    public String deleteComments(@ShellOption (defaultValue = "0") String bookId) {
        return bookProcessor.deleteAllCommentsByBook(bookId);
    }

    @ShellMethod(value = "Show all comments by book", key = {"showcom", "scom"})
    public String showComments(@ShellOption (defaultValue = "0") String bookId) {
